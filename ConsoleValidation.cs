...
namespace MontyHall
{
    public class ConsoleValidation
    {
        ...
        private bool ValidateUserInputNumberOfGames(GameSettingsModel gameSettings, string userInput)
        {
        ...
        private bool ValidateUserInputChangeDoor(GameSettingsModel gameSettings, string userInput)
        {
            if (userInput != null)
            {
